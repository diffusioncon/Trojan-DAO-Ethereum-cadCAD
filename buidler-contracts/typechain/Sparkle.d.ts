...
interface SparkleInterface extends Interface {
  functions: {
...
export class Sparkle extends Contract {
  connect(signerOrProvider: Signer | Provider | string): Sparkle;
  attach(addressOrName: string): Sparkle;
  deployed(): Promise<Sparkle>;

  on(event: EventFilter | string, listener: Listener): Sparkle;
  once(event: EventFilter | string, listener: Listener): Sparkle;
  addListener(eventName: EventFilter | string, listener: Listener): Sparkle;
  removeAllListeners(eventName: EventFilter | string): Sparkle;
  removeListener(eventName: any, listener: Listener): Sparkle;

  interface: SparkleInterface;
